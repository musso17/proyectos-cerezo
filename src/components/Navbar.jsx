  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-emerald-500 via-emerald-500 to-lime-500 text-slate-900 shadow-[0_18px_40px_rgba(16,185,129,0.45)] transition hover:-translate-y-1 hover:shadow-[0_28px_56px_rgba(16,185,129,0.55)] sm:hidden"
      >
        <Plus size={22} />
      </button>
    </>
